@file:JvmName("fishcute.celestial.expressions.Expression")
...
fun interface Expression: ()->Double {
    ...
    class Empty: Expression {
        override fun invoke() = throw ExecutionError("fishcute.celestial.expressions.Expression was executed before it was fully processed.")
